...
static_assert(
  std::is_same_v<util::with_const_as_t<double volatile, int const>, double volatile const>);
static_assert(
  std::is_same_v<util::with_const_as_t<double volatile const, int const>, double volatile const>);
...
static_assert(std::is_same_v<util::with_const_as_t<double volatile&&, int>, double volatile&&>);
static_assert(
  std::is_same_v<util::with_const_as_t<double volatile const&&, int>, double volatile&&>);
static_assert(
  std::is_same_v<util::with_const_as_t<double volatile&&, int const>, double volatile const&&>);
static_assert(std::is_same_v<util::with_const_as_t<double volatile const&&, int const>,
                             double volatile const&&>);
...
static_assert(
  std::is_same_v<util::strip_referenceness_t<std::reference_wrapper<std::reference_wrapper<int>>>,
                 int>);
...
static_assert(
  std::is_same_v<util::lvalue_reference_into_wrapper_t<int&>, std::reference_wrapper<int>>);
static_assert(std::is_same_v<util::lvalue_reference_into_wrapper_t<int const&>,
                             std::reference_wrapper<int const>>);
static_assert(std::is_same_v<util::lvalue_reference_into_wrapper_t<int&&>, int>);
static_assert(std::is_same_v<util::lvalue_reference_into_wrapper_t<int const&&>, int const>);
static_assert(std::is_same_v<util::lvalue_reference_into_wrapper_t<std::reference_wrapper<int>>,
                             std::reference_wrapper<int>>);
static_assert(
  std::is_same_v<util::lvalue_reference_into_wrapper_t<std::reference_wrapper<int> const>,
                 std::reference_wrapper<int> const>);
static_assert(
  std::is_same_v<util::lvalue_reference_into_wrapper_t<std::reference_wrapper<int const>>,
                 std::reference_wrapper<int const>>);
static_assert(
  std::is_same_v<util::lvalue_reference_into_wrapper_t<std::reference_wrapper<int const> const>,
                 std::reference_wrapper<int const> const>);
static_assert(std::is_same_v<util::lvalue_reference_into_wrapper_t<std::reference_wrapper<int>&>,
                             std::reference_wrapper<int>>);
static_assert(
  std::is_same_v<util::lvalue_reference_into_wrapper_t<std::reference_wrapper<int> const&>,
...
void lvalue_reference_into_wrapper_test()
{
  ...
  static_assert(
    std::is_same_v<decltype(ref_ref), util::lvalue_reference_into_wrapper_t<decltype(ref)>>);
  static_assert(
    std::is_same_v<decltype(ref_cref), util::lvalue_reference_into_wrapper_t<decltype(cref)>>);
  static_assert(
    std::is_same_v<decltype(ref_refw), util::lvalue_reference_into_wrapper_t<decltype(refw)>>);
  static_assert(
    std::is_same_v<decltype(ref_crefw), util::lvalue_reference_into_wrapper_t<decltype(crefw)>>);
